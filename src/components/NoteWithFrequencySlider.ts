export const createNoteWithFrequencySlider = (
  ...
  const frequencyMinInput = document.createElement("input") as HTMLInputElement;
  frequencyMinInput.type = "Number";
  frequencyMinInput.max = "20000";
  frequencyMinInput.min = "0";
  frequencyMinInput.placeholder = "min hz";
  const frequencyMaxInput = document.createElement("input") as HTMLInputElement;
